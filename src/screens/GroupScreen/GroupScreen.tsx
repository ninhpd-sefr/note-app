...
import MoveNoteModal from "../../components/MoveNoteModal/MoveNoteModal";
...
import UnlockNoteModal from "../../components/UnlockNoteModal/UnlockNoteModal";
...
const GroupScreen: React.FC<Props> = ({ route }) => {
  ...
  const handleAddNote = useCallback(
    async (title: string, content: string, imageUrl?: string) => {
      ...
      if (success) {
        showSnackbar(t("group.note.added"), "success");
  ...
  const handleDeleteNote = useCallback(async () => {
    ...
    Alert.alert(t("group.delete.note.title"), t("group.delete.note.message"), [
      { text: t("group.delete.note.cancel"), style: "cancel" },
      {
        text: t("group.delete.note.delete"),
        style: "destructive",
        onPress: async () => {
  ...
  const handleMoveNote = useCallback(
    async (newGroupId: string) => {
      ...
      if (success) {
        showSnackbar(t("group.note.moved"), "success");
    ...
    <SafeAreaView style={styles.container}>
      <View style={styles.container}>
        ...
        >
          ...
          <Text style={styles.backText}>{t("group.back")}</Text>
        </TouchableOpacity>
        {/* Group Title */}
        ...
        {loadingNote ? (
          ...
          <FlatList
            ...
            ListEmptyComponent={<EmptyState message={t("group.no.notes")} />}
        ...
        <UnlockNoteModal
          title={t("group.view.note.title")}
          subTitle={t("group.view.note.subtitle")}
        ...
        <UnlockNoteModal
          title={t("group.remove.lock.title")}
          subTitle={t("group.remove.lock.subtitle")}
        ...
        <UnlockNoteModal
          title={t("group.lock.note.title")}
          subTitle={t("group.lock.note.subtitle")}
        ...
        >
          <Menu.Item
            title={
              selectedNote?.pinned ? t("group.unpin.note") : t("group.pin.note")
            }
            leadingIcon={({ size }) => (
